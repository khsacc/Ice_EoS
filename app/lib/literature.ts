...
export const LITERATURE: Record<IcePolymorph, LiteratureEntry[]> = {
  ...
  VII: [
    ...
    {
      id: 'vii_h2o_lai2023',
      citation: 'Lai et al. (2023)',
      fullRef: 'Lai, X., Zhu, F., Zhang, D., Tkachev, S., Prakapenka, V. B., Chao, K.-H., & Chen, B. (2023). Thermal equation of state of ice-VII revisited by single-crystal X-ray diffraction. American Mineralogist, 108(8), 1530–1537.',
      doi: '10.2138/am-2022-8554',
      eosType: 'BM3Thermal',
      molecule: 'H2O',
      // Table 1 "This study", BM EoS thermal. V₀=12.3 cm³/mol fixed at 300 K.
      // K₀(T)=K₀+dK/dT·(T−300); V(T)=V₀[1+α₀(T−300)+½α₁(T−300)²] [Berman 1988]
      params: {
        V0:     { value: '12.3',     unit: 'cm3/mol' },
        T_ref:  { value: '300',      unit: 'K' },
        P_ref:  { value: '0',        unit: 'GPa' },
        K0:     { value: '21.0(4)',  unit: 'GPa' },
        K0p:    { value: '4.45(6)', unit: '1' },
        alpha:  { value: '15(5)',    unit: '10-5/K' },
        alpha1: { value: '15(8)',    unit: '10-8/K2' },
        dKdT:   { value: '-0.009(4)', unit: 'GPa/K' },
      },
      notes: 'Table 1, Berman (1988) thermal BM3. Valid 3.5–78.2 GPa, 300–1000 K. SCXRD.',
    },
    {
      id: 'vii_h2o_lai2023_300k',
      citation: 'Lai et al. (2023) 300 K',
      fullRef: 'Lai, X., Zhu, F., Zhang, D., Tkachev, S., Prakapenka, V. B., Chao, K.-H., & Chen, B. (2023). Thermal equation of state of ice-VII revisited by single-crystal X-ray diffraction. American Mineralogist, 108(8), 1530–1537.',
      doi: '10.2138/am-2022-8554',
      eosType: 'BM3',
      molecule: 'H2O',
      ...
      params: {
        V0:    { value: '12.4(2)',  unit: 'cm3/mol' },
        T_ref: { value: '300',     unit: 'K' },
        P_ref: { value: '0',       unit: 'GPa' },
        K0:    { value: '19.2(15)', unit: 'GPa' },
        K0p:   { value: '4.6(2)',  unit: '1' },
      },
      notes: 'Table 1, isothermal BM3 at 300 K (fitted V₀). Valid 3.5–78.2 GPa. SCXRD.',
    },
    {
      id: 'vii_h2o_lai2023_300k_vinet',
      citation: 'Lai et al. (2023) Vinet 300 K',
      fullRef: 'Lai, X., Zhu, F., Zhang, D., Tkachev, S., Prakapenka, V. B., Chao, K.-H., & Chen, B. (2023). Thermal equation of state of ice-VII revisited by single-crystal X-ray diffraction. American Mineralogist, 108(8), 1530–1537.',
      doi: '10.2138/am-2022-8554',
      eosType: 'Vinet',
      molecule: 'H2O',
      isothermal: true,
      // Table 1 "This study", Vinet EoS 300 K fit (V₀ fitted, preferred by authors over fixed-V₀ fit).
      params: {
        V0:    { value: '12.7(2)', unit: 'cm3/mol' },
        T_ref: { value: '300',    unit: 'K' },
        P_ref: { value: '0',      unit: 'GPa' },
        K0:    { value: '15(2)',  unit: 'GPa' },
        K0p:   { value: '5.6(2)', unit: '1' },
      },
